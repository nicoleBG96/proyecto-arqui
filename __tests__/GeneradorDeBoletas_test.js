...
describe("GeneradorDeBoletas", function () {
    ...
    test("dado el empleado Royer Torrico a la hora de generar su boleta el dia 5/31/2019 que le corresponde, deberia generar su boleta con todos los datos respectivos", function () {
        ...
        let notificador2 = new Notificador();
        notificador2 = new NotificadorEmail(notificador2);
        let destinatario = 'tefi1508@gmail.com';
        notificador2.asignarDestinatario(destinatario);
        let metodoDePago2 = new PagoPorDeposito();
        let empleado2 = new Empleado("Laura Meneses", "T-124", 8798416, "Sub Gerente", calculadoraDeSalario2, verificadorFechaDePagoEmpleadoFijo2, notificador2, metodoDePago2, null);
        let fecha = new Date('5, 31, 2019');
        let generadorDeBoletas = new GeneradorDeBoletas();
    ...
    test("dado el empleado Royer Torrico a la hora de generar su boleta el dia 5/31/2019 que le corresponde, deberia generar su boleta con todos los datos respectivos", function () {
        ...
        let notificador3 = new Notificador();
        notificador3 = new NotificadorEmail(notificador3);
        let destinatario = 'tefi1508@gmail.com';
        notificador3.asignarDestinatario(destinatario);
        let metodoDePago3 = new PagoPorDeposito();
        let empleado3 = new Empleado("Ronald Escobar", "T-125", 8798417, "Ingeniero", calculadoraDeSalario3, verificadorFechaDePagoEmpleadoFijo3, notificador3, metodoDePago3, null);
        let fecha = new Date('5, 31, 2019');
        let generadorDeBoletas = new GeneradorDeBoletas();
    ...
    test("dada una lista de 3 empleados a la hora de generar sus boleta el dia 5/31/2019 que les corresponde, deberia generar sus boletas con todos los datos respectivos", function () {
        ...
        let notificador1 = new Notificador();
        notificador1 = new NotificadorEmail(notificador1);
        let destinatario = 'tefi1508@gmail.com';
        notificador1.asignarDestinatario(destinatario);
        let metodoDePago1 = new PagoPorDeposito();
        let empleado1 = new Empleado("Royer Torrico", "T-123", 8798415, "Champion", calculadoraDeSalario1, verificadorFechaDePagoEmpleadoFijo1, notificador1, metodoDePago1, null);
